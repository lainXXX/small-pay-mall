...
import com.rem.types.sdk.weixin.message.TextMessage;
...
//        TODO 因为前端只有loginKey来保证用户登录id的唯一性 所以需要再使用loginKey取出ticket 这个逻辑我目前认为是有问题的 但是后续如果有机会再思考更好的处理
    ...
    public String post(String xmlString) throws IOException {
        ...
        if (StringUtils.isNotBlank(ticket)) {
            ...
            WeixinTemplateMessage wxTemplateDTO = WeixinTemplateMessage.createLoginTemplate(message.getFromUserName(), template_id);
